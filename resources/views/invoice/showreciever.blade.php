...
@section('page')
الفواتير التى تم ارسالها من الشركات الى المكتب
@endsection
...
<table id="html5-extension" class="table table-hover non-hover" style="width:100%">
    ...
    <tbody>
        ...
        @if($invoice['issuerId'] !== "410973742" && $invoice['receiverId'] === "410973742")
        <tr>
            ...
            <td>
                <form action="{{ route('RejectDocument',$invoice['uuid']) }}" method="post">
                    @csrf
                    @method('PUT')
                    <button class="btn btn-danger" type="submit">رفض الفاتورة</button>
                </form>
            </td>
        </tr>
        @endif
